...
class LabelPoints(tag: Tag)
  ...
  def * = (LabelPointId, LabelId, svImageX, svImageY, originalCanvasX, originalCanvasY, originalHeading, originalPitch, originalZoom, canvasX, canvasY, heading, pitch, zoom,
